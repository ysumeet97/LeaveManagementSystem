...
//$result = mysql_query("SELECT * FROM users ORDER BY id DESC"); // mysql_query is deprecated
//UserID,FullName,Telphone,Email,User_Type,LeaveBalance
$resultnote = mysqli_query($con, "SELECT * FROM leavenotifications ORDER BY NoteID  DESC"); // resultnoteusing mysqli_query instead
?>
...
<h2 align="center">ANUAL LEAVE NOTIFICATION </h2>
<div id="form" style="padding-left:100px">
				

		<h2 align="center">SELECT STAFF TO SEND NOTIFICATION </h2>
        ...
        <tr bgcolor='#CCCCCC'>
			...
			<td width="19%">Leave Balance</td>
			<td width="18%">Send notification</td>
        </tr>
        <?php 
        ...
        while($res = mysqli_fetch_array($result)) {         
            ...
            echo "<td><a href=\"staffsnotifications.php?UserID=$res[UserID]\" onClick=\"return confirm('Are you sure you want to send notification?')\">Send annual leave notifiction</a></td>";        
        }
        ?>
  </table>
  ...
  <h2 align="center">THE SENT NOTIFICATION </h2>
        <table width='89%' border=2>
        <tr bgcolor='#CCCCCC'>
